        ...
        <div class="content index width mx-auto px3 my4">
                ...
                <div id="nav">
                    <ul>
                        ...
                        <li>
						 ...
						 <li>
                            <a href="/category/original/.html">original</a>
                        </li>
            ...
            <section id="wrapper" class="home">
                <section id="about">
                    ...
                    <p class="prompt ad-text output new-output">The website already supports PWA, you can try to add to the desktop</p>
                </section>
                <section id="writing">
                    <span class="h1">
                ...
                <section id="projects">
                    <span class="h1">
                        <a href="/category/original/.html" rel="external nofollow noopener noreferrer" target="_blank">Projects</a>
                    </span>
