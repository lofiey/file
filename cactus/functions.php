...
function Projects($sorts = NULL) {
    ...
    echo $Project ? $Project : '年年岁岁花相似，岁岁年年人不同。';
}
...
function spam_protection_math(){
    ...
    $num2=rand(1,9);
    echo "$num1 + $num2 = ";
    echo "<input type=\"text\" name=\"sum\" class=\"vnick vinput\" value=\"\" size=\"25\" tabindex=\"4\" style=\" width:70px;\" placeholder=\"Calculation results\">\n";
...
function spam_protection_pre($comment, $post, $result){
    ...
    switch($sum){
        ...
        break;
        case null:
        throw new Typecho_Widget_Exception(_t('Sorry: Please enter the verification code','Comment failed'));
        break;
        default:
        throw new Typecho_Widget_Exception(_t('Sorry: the verification code is wrong, please go back and try again','Comment failed'));
